...
namespace PaymentProcessor.UnitTests
{
    ...
    public static class PaymentRequestServiceTestCaseSource
    {
        ...
        public static PaymentRequestDto FirstTierPaymentRequestDto { get { return new PaymentRequestDto() { Amount = 100, CardHolder = "Ramesh", CreditCardNumber = "1402 2326 3830 4155", ExpirationDate = DateTime.Now.AddYears(2), SecurityCode = "345" }; }  }
        public static PaymentRequestDto SecondTierPaymentRequestDto { get { return new PaymentRequestDto() { Amount = 200, CardHolder = "Raju", CreditCardNumber = "1402 4326 5830 6155", ExpirationDate = DateTime.Now.AddYears(2), SecurityCode = "890" }; } }
        public static PaymentRequestDto LastTierPaymentRequestDto { get { return new PaymentRequestDto() { Amount = 300, CardHolder = "Kumar", CreditCardNumber = "3402 5326 7830 9155", ExpirationDate = DateTime.Now.AddYears(2), SecurityCode = "789" }; } }
